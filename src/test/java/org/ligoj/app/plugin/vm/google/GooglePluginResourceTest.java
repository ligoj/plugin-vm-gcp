...
import org.ligoj.app.plugin.vm.google.GooglePluginResource;
import org.ligoj.app.plugin.vm.google.Vm;
...
public class GooglePluginResourceTest extends AbstractServerTest {
	...
	public void checkStatusAuthenticationFailed() throws Exception {
		thrown.expect(ValidationJsonException.class);
		thrown.expect(MatcherUtil.validationMatcher(GooglePluginResource.PARAMETER_URL, "vcloud-login"));
	...
	public void checkStatusNotAdmin() throws Exception {
		thrown.expect(ValidationJsonException.class);
		thrown.expect(MatcherUtil.validationMatcher(GooglePluginResource.PARAMETER_URL, "vcloud-admin"));
		prepareMockHome();
		httpServer.start();
		resource.checkStatus(subscriptionResource.getParametersNoCheck(subscription));
	}
